<template>
  <div class="login">
    ...
    <div class="header container">
      <a href="/index">
        <h2 class="login_title">智能化共享租赁平台用户登录</h2>
      </a>
    </div>
    <!-- 中间背景图片 -->
    <div class="login-bg">
      <img src="https://z3.ax1x.com/2021/04/12/cBnPOJ.png" alt="" />
    </div>
    <!-- 登录框 -->
      ...
      <div class="login-box">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <!-- <el-tab-pane label="短信登录" name="second">
            ...
            <div class="loginbtn" @click="loginClick1">登录</div>
  ...
  methods: {
    ...
    async loginClick() {
      if (this.user.username === "") {
        ...
        const {data:res} = await this.$http.post('/user/service-user/user/userLogin',this.user)
