    ...
    <div class="container">
        ...
        <div class="detail-swiper">
          <swiper :options="swiperOption">
            ...
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/02/1582699684678379.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/02/1582699684651481.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/02/1582699684679130.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/02/1582699684657643.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
      ...
      <div class="right">
        ...
        <div class="header">
          <h2>{{ product.name3 }}</h2>
          <p class="desc">
            全新 微软Microsoft Surface Pro 7
            二合一笔记本电脑（i7/16GB/512GB/12.3''/Win10H 不含键盘/触控笔）
          </p>
          <div class="monthly_rent">
            <div class="color">租金：</div>
            <div class="now-price">{{ product.price3 }}元起</div>
        ...
        <!-- 选择租赁时间 -->
        <el-radio-group v-model="radio3" v-show="choosetime">
          <!-- 第一个 -->
          <div>
            <div class="choose_radio">
              <el-radio :label="1">周租金 {{ product.week3 }} 元</el-radio>
            ...
            <div class="detail_choose">
              （平均周租金：190元；少于一周按一周算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
          ...
          <div>
            <div class="choose_radio">
              <el-radio :label="2">月租金 {{ product.month3 }} 元</el-radio>
              <el-button class="default_button default_button1"
                >非固定租期</el-button
              >
              <div class="hint">
            ...
            <div class="detail_choose">
              （平均月租金：725元；少于一个月按一个月算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
        </el-radio-group>
        ...
        <div class="choosenum">
          ...
          <div class="cnum">
            <el-input-number
              ...
              :max="8"
            ></el-input-number
            ><span class="quantity_num">库存数量：{{ product.quantity3 }}</span>
          </div>
        </div>
        ...
        <div class="cash_pledge">
          ...
          <div class="cash">
            设备押金：<span>￥{{ product.pledge3 }}</span>
          </div>
        </div>
        ...
        <div class="total">
          <div class="top">
            <div>
              <span class="name">{{ product.name3 }} </span>
            </div>
          </div>
          <p class="totalprice" v-if="isNaN(detailtotal)">总计：190元</p>
...
export default {
  ...
  data() {
    return {
      ...
      product: {
        id: 1,
        name3:
          "全新 微软Microsoft Surface Pro 7 二合一笔记本电脑（i7/16GB/512GB/12.3''/Win10H 不含键盘/触控笔）",
        price3: "￥190",
        week3: 190.0,
        month3: 725.0,
        quantity3: 8,
  ...
  computed: {
    ...
    detailtotal: function () {
      ...
      if (this.radio3 === 1) {
        ...
        var result = weeknum * 190 * this.num3;
        if (result < 0) {
          var result = 0;
        }
        ...
        var result = monthnum * 725 * this.num3;
        if (result < 0) {
          var result = 0;
        }
  ...
  methods: {
    ...
    immLease(id) {
      ...
      // 租赁数量
      window.sessionStorage.setItem("detailnum", this.num3);
      // var detailnum = sessionStorage.getItem("detailnum");
      // console.log(detailnum + "数量");
      // 租赁名称
      window.sessionStorage.setItem("detailname", this.product.name3);
      ...
      window.sessionStorage.setItem(
        "detailimg",
        "https://oss.aiterent.com/files/2020/02/1582699684678379.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
      );
