    ...
    <div class="container">
        ...
        <div class="detail-swiper">
          <swiper :options="swiperOption">
            ...
            <swiper-slide class="swiper-item">
              <img
                src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=1685328903,4181455551&fm=26&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=2048869676,1768511680&fm=26&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=766079006,1019725102&fm=15&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=1121161205,2200841929&fm=26&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
      ...
      <div class="right">
        ...
        <div class="header">
          <h2>{{ product.name4 }}</h2>
          <p class="desc">
            佳能600d（18-135套机）像数：1800万 镜头：18-135mm
            连拍速度：约3.7张/秒 快门：1/60-1/4000秒
          </p>
          <div class="monthly_rent">
            <div class="color">租金：</div>
            <div class="now-price">{{ product.price4 }}元起</div>
            <div class="equipment">非新设备</div>
          </div>
        </div>
        ...
        <!-- 选择租赁时间 -->
        <el-radio-group v-model="radio4" v-show="choosetime">
          <!-- 第一个 -->
          <div>
            <div class="choose_radio">
              <el-radio :label="1">周租金 {{ product.week4 }} 元</el-radio>
            ...
            <div class="detail_choose">
              （平均周租金：120元；少于一周按一周算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
          ...
          <div>
            <div class="choose_radio">
              <el-radio :label="2">月租金 {{ product.month4 }} 元</el-radio>
              <el-button class="default_button default_button1"
                >非固定租期</el-button
              >
              <div class="hint">
            ...
            <div class="detail_choose">
              （平均月租金：400元；少于一个月按一个月算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
        </el-radio-group>
        ...
        <div class="choosenum">
          ...
          <div class="cnum">
            <el-input-number
              ...
              :max="15"
            ></el-input-number
            ><span class="quantity_num">库存数量：{{ product.quantity4 }}</span>
          </div>
        </div>
        ...
        <div class="cash_pledge">
          ...
          <div class="cash">
            设备押金：<span>￥{{ product.pledge4 }}</span>
          </div>
        </div>
        ...
        <div class="total">
          <div class="top">
            <div>
              <span class="name">{{ product.name4 }} </span>
            </div>
          </div>
          <p class="totalprice" v-if="isNaN(detailtotal)">总计：120元</p>
...
export default {
  ...
  data() {
    return {
      ...
      product: {
        id: 1,
        name4:
          "佳能600d（18-135套机）像数：1800万 镜头：18-135mm 连拍速度：约3.7张/秒 快门：1/60-1/4000秒",
        price4: "￥120",
        week4: 120.0,
        month4: 400.0,
        quantity4: 15,
  ...
  computed: {
    ...
    detailtotal: function () {
      ...
      if (this.radio4 === 1) {
        ...
        var result = weeknum * 120 * this.num4;
        if (result < 0) {
          var result = 0;
        }
        ...
        var result = monthnum * 400 * this.num4;
        if (result < 0) {
          var result = 0;
        }
  ...
  methods: {
    ...
    immLease(id) {
      ...
      // 租赁数量
      window.sessionStorage.setItem("detailnum", this.num4);
      // var detailnum = sessionStorage.getItem("detailnum");
      // console.log(detailnum + "数量");
      // 租赁名称
      window.sessionStorage.setItem("detailname", this.product.name4);
      ...
      window.sessionStorage.setItem(
        "detailimg",
        "https://gitee.com/Gumpxd/images/raw/master/20210407095357.png"
      );
