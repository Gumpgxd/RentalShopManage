  ...
  <div>
    ...
    <div class="container">
        ...
        <div class="detail-swiper">
          <swiper :options="swiperOption">
            ...
            <swiper-slide class="swiper-item">
              <img
                src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2414571943,2815441393&fm=15&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1144354920,326978151&fm=15&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1965302484,2264933149&fm=26&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3386228945,3799869980&fm=26&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
      ...
      <div class="right">
        ...
        <div class="header">
          <h2>{{ product.name7 }}</h2>
          <p class="desc">GoPro5 BLACK户外运动潜水高清运动相机</p>
          <div class="monthly_rent">
            <div class="color">租金：</div>
            <div class="now-price">{{ product.price7 }}元起</div>
        ...
        <!-- 选择租赁时间 -->
        <el-radio-group v-model="radio7" v-show="choosetime">
          <!-- 第一个 -->
          <div>
            <div class="choose_radio">
              <el-radio :label="1">周租金 {{ product.week7 }} 元</el-radio>
          ...
          <div>
            <div class="choose_radio">
              <el-radio :label="2">月租金 {{ product.month7 }} 元</el-radio>
              <el-button class="default_button default_button1"
                >非固定租期</el-button
              >
              <div class="hint">
            ...
            <div class="detail_choose">
              （平均月租金：280元；少于一个月按一个月算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
        </el-radio-group>
        ...
        <div class="choosenum">
          ...
          <div class="cnum">
            <el-input-number
              ...
              :max="12"
            ></el-input-number
            ><span class="quantity_num">库存数量：{{ product.quantity7 }}</span>
          </div>
        </div>
        ...
        <div class="cash_pledge">
          ...
          <div class="cash">
            设备押金：<span>￥{{ product.pledge7 }}</span>
          </div>
        </div>
        ...
        <div class="total">
          <div class="top">
            <div>
              <span class="name">{{ product.name7 }} </span>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      product: {
        id: 1,
        name7: "GoPro5 BLACK户外运动潜水高清运动相机",
        price7: "￥70",
        week7: 70.0,
        month7: 280.0,
        quantity7: 12,
  ...
  computed: {
    ...
    detailtotal: function () {
      ...
      if (this.radio7 === 1) {
        ...
        var result = weeknum * 70 * this.num7;
        if (result < 0) {
          var result = 0;
        }
        ...
        var result = monthnum * 280 * this.num7;
        if (result < 0) {
          var result = 0;
        }
  ...
  methods: {
    ...
    immLease(id) {
      ...
      // 租赁数量
      window.sessionStorage.setItem("detailnum", this.num7);
      // var detailnum = sessionStorage.getItem("detailnum");
      // console.log(detailnum + "数量");
      // 租赁名称
      window.sessionStorage.setItem("detailname", this.product.name7);
      ...
      window.sessionStorage.setItem(
        "detailimg",
        "https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2414571943,2815441393&fm=15&gp=0.jpg"
      );
