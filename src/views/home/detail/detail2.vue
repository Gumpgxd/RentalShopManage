    ...
    <div class="container">
        ...
        <div class="detail-swiper">
          <swiper :options="swiperOption">
            ...
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/05/1590385229905304.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/05/1590385229894337.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/05/1590385229903382.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/05/1590385229931361.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
      ...
      <div class="right">
        ...
        <div class="header">
          <h2>{{ product.name2 }}</h2>
          <p class="desc">
            全新 苹果Apple MacBook Pro 13" 2020 笔记本电脑（i5-2.0G/16GB/512GB SSD/13.3"/2K）
          </p>
          <div class="monthly_rent">
            <div class="color">租金：</div>
            <div class="now-price">{{ product.price2 }}元起</div>
            <div class="equipment">全新设备</div>
          </div>
        </div>
        ...
        <!-- 选择租赁时间 -->
        <el-radio-group v-model="radio2" v-show="choosetime">
          <!-- 第一个 -->
          <div>
            <div class="choose_radio">
              <el-radio :label="1">周租金 {{ product.week2 }} 元</el-radio>
            ...
            <div class="detail_choose">
              （平均周租金：150元；少于一周按一周算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
          ...
          <div>
            <div class="choose_radio">
              <el-radio :label="2">月租金 {{ product.month2 }} 元</el-radio>
              <el-button class="default_button default_button1"
                >非固定租期</el-button
              >
              <div class="hint">
            ...
            <div class="detail_choose">
              （平均月租金：575元；少于一个月按一个月算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
        </el-radio-group>
        ...
        <div class="choosenum">
          ...
          <div class="cnum">
            <el-input-number
              ...
              :max="15"
            ></el-input-number
            ><span class="quantity_num">库存数量：{{ product.quantity2 }}</span>
          </div>
        </div>
        ...
        <div class="cash_pledge">
          ...
          <div class="cash">
            设备押金：<span>￥{{ product.pledge2 }}</span>
          </div>
        </div>
        ...
        <div class="total">
          <div class="top">
            <div>
              <span class="name">{{ product.name2 }} </span>
            </div>
          </div>
          <p class="totalprice" v-if="isNaN(detailtotal)">总计：150元</p>
...
export default {
  ...
  data() {
    return {
      ...
      product: {
        id: 1,
        name2: "全新 苹果Apple MacBook Pro 13 2020 笔记本电脑（i5-2.0G/16GB/512GB SSD/13.3/2K）",
        price2: "￥150",
        week2: 150.0,
        month2: 575.0,
        quantity2: 15,
  ...
  computed: {
    ...
    detailtotal: function () {
      ...
      if (this.radio2 === 1) {
        ...
        var result = weeknum * 150 * this.num2;
        if (result < 0) {
          var result = 0;
        }
        ...
        var result = monthnum * 575 * this.num2;
        if (result < 0) {
          var result = 0;
        }
  ...
  methods: {
    ...
    immLease(id) {
      ...
      // 租赁数量
      window.sessionStorage.setItem("detailnum", this.num2);
      // var detailnum = sessionStorage.getItem("detailnum");
      // console.log(detailnum + "数量");
      // 租赁名称
      window.sessionStorage.setItem("detailname", this.product.name2);
      ...
      // 获取图片
      window.sessionStorage.setItem("detailimg",'https://oss.aiterent.com/files/2020/05/1590385229905304.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450')
