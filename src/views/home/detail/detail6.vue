    ...
    <div class="container">
        ...
        <div class="detail-swiper">
          <swiper :options="swiperOption">
            ...
            <swiper-slide class="swiper-item">
              <img
                src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2472646602,3889807645&fm=26&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=775787535,2786088079&fm=26&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=54165562,3776282409&fm=26&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=3016863164,2975128819&fm=11&gp=0.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
      ...
      <div class="right">
        ...
        <div class="header">
          <h2>{{ product.name6 }}</h2>
          <p class="desc">
            索尼／sony x280 高清摄像机拍摄套装ex280升级，直播竖拍
          </p>
          <div class="monthly_rent">
            <div class="color">租金：</div>
            <div class="now-price">{{ product.price6 }}元起</div>
        ...
        <!-- 选择租赁时间 -->
        <el-radio-group v-model="radio6" v-show="choosetime">
          <!-- 第一个 -->
          <div>
            <div class="choose_radio">
              <el-radio :label="1">周租金 {{ product.week6 }} 元</el-radio>
            ...
            <div class="detail_choose">
              （平均周租金：800元；少于一周按一周算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
          ...
          <div>
            <div class="choose_radio">
              <el-radio :label="2">月租金 {{ product.month6 }} 元</el-radio>
              <el-button class="default_button default_button1"
                >非固定租期</el-button
              >
              <div class="hint">
            ...
            <div class="detail_choose">
              （平均月租金：3000元；少于一个月按一个月算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
        </el-radio-group>
        ...
        <div class="choosenum">
          ...
          <div class="cnum">
            <el-input-number
              ...
              :max="1"
            ></el-input-number
            ><span class="quantity_num">库存数量：{{ product.quantity6 }}</span>
          </div>
        </div>
        ...
        <div class="cash_pledge">
          ...
          <div class="cash">
            设备押金：<span>￥{{ product.pledge6 }}</span>
          </div>
        </div>
        ...
        <div class="total">
          <div class="top">
            <div>
              <span class="name">{{ product.name6 }} </span>
            </div>
          </div>
          <p class="totalprice" v-if="isNaN(detailtotal)">总计：800元</p>
...
export default {
  ...
  data() {
    return {
      ...
      product: {
        id: 1,
        name6: "索尼／sony x280 高清摄像机拍摄套装ex280升级，直播竖拍",
        price6: "￥500",
        week6: 800.0,
        month6: 3000.0,
        quantity6: 1,
  ...
  computed: {
    ...
    detailtotal: function () {
      ...
      if (this.radio6 === 1) {
        ...
        var result = weeknum * 800 * this.num6;
        if (result < 0) {
          var result = 0;
        }
        ...
        var result = monthnum * 3000 * this.num6;
        if (result < 0) {
          var result = 0;
        }
  ...
  methods: {
    ...
    immLease(id) {
      ...
      // 租赁数量
      window.sessionStorage.setItem("detailnum", this.num6);
      // var detailnum = sessionStorage.getItem("detailnum");
      // console.log(detailnum + "数量");
      // 租赁名称
      window.sessionStorage.setItem("detailname", this.product.name6);
      ...
      window.sessionStorage.setItem(
        "detailimg",
        "https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2472646602,3889807645&fm=26&gp=0.jpg"
      );
