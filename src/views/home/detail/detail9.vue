  ...
  <div>
    ...
    <div class="container">
        ...
        <div class="detail-swiper">
          <swiper :options="swiperOption">
            ...
            <swiper-slide class="swiper-item">
              <img
                src="https://api.hainiaowo.com/upload/testtemp/4ebb583466d8074248dd0a3310c98d07.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
      ...
      <div class="right">
        ...
        <div class="header">
          <h2>{{ product.name9 }}</h2>
          <p class="desc">享玩 HTC VIVE VR眼镜</p>
          <div class="monthly_rent">
            <div class="color">租金：</div>
            <div class="now-price">{{ product.price9 }}元起</div>
        ...
        <!-- 选择租赁时间 -->
        <el-radio-group v-model="radio9" v-show="choosetime">
          <!-- 第一个 -->
          <div>
            <div class="choose_radio">
              <el-radio :label="1">周租金 {{ product.week9 }} 元</el-radio>
            ...
            <div class="detail_choose">
              （平均周租金：400元；少于一周按一周算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
          ...
          <div>
            <div class="choose_radio">
              <el-radio :label="2">月租金 {{ product.month9 }} 元</el-radio>
              <el-button class="default_button default_button1"
                >非固定租期</el-button
              >
              <div class="hint">
            ...
            <div class="detail_choose">
              （平均月租金：1600元；少于一个月按一个月算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
        </el-radio-group>
        ...
        <div class="choosenum">
          ...
          <div class="cnum">
            <el-input-number
              ...
              :max="2"
            ></el-input-number
            ><span class="quantity_num">库存数量：{{ product.quantity9 }}</span>
          </div>
        </div>
        ...
        <div class="cash_pledge">
          ...
          <div class="cash">
            设备押金：<span>￥{{ product.pledge9 }}</span>
          </div>
        </div>
        ...
        <div class="total">
          <div class="top">
            <div>
              <span class="name">{{ product.name9 }} </span>
            </div>
          </div>
          <p class="totalprice" v-if="isNaN(detailtotal)">总计：400元</p>
...
export default {
  ...
  computed: {
    ...
    detailtotal: function () {
      ...
      if (this.radio9 === 1) {
        ...
        var result = weeknum * 400 * this.num9;
        if (result < 0) {
          var result = 0;
        }
        ...
        var result = monthnum * 1600 * this.num9;
        if (result < 0) {
          var result = 0;
        }
  ...
  methods: {
    ...
    immLease(id) {
      ...
      // 租赁数量
      window.sessionStorage.setItem("detailnum", this.num9);
      // var detailnum = sessionStorage.getItem("detailnum");
      // console.log(detailnum + "数量");
      // 租赁名称
      window.sessionStorage.setItem("detailname", this.product.name9);
      ...
      window.sessionStorage.setItem(
        "detailimg",
        "https://api.hainiaowo.com/upload/testtemp/4ebb583466d8074248dd0a3310c98d07.jpg"
      );
