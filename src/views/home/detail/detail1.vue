    ...
    <div class="container">
        ...
        <div class="detail-swiper">
          <swiper :options="swiperOption">
            ...
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/12/1606979288789694.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/12/1606979288791713.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/12/1606979288779401.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://oss.aiterent.com/files/2020/12/1606979288759142.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
      ...
      <div class="right">
        ...
        <div class="header">
          <h2>{{ product.name1 }}</h2>
          <p class="desc">
            全新 火影(FIREBAT) T5V 笔记本电脑（i5-10200H/8GB/512GB SSD/GTX1650
            4G/15.6"）
          </p>
          <div class="monthly_rent">
            <div class="color">租金：</div>
            <div class="now-price">{{ product.price1 }}元起</div>
        ...
        <!-- 选择租赁时间 -->
        <el-radio-group v-model="radio1" v-show="choosetime">
          <!-- 第一个 -->
          <div>
            <div class="choose_radio">
              <el-radio :label="1">周租金 {{ product.week1 }} 元</el-radio>
            ...
            <div class="detail_choose">
              （平均周租金：70元；少于一周按一周算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
          ...
          <div>
            <div class="choose_radio">
              <el-radio :label="2">月租金 {{ product.month1 }} 元</el-radio>
              <el-button class="default_button default_button1"
                >非固定租期</el-button
              >
              <div class="hint">
            ...
            <div class="detail_choose">
              （平均月租金：266元；少于一个月按一个月算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
        </el-radio-group>
        ...
        <div class="choosenum">
          ...
          <div class="cnum">
            <el-input-number
              ...
              :max="30"
            ></el-input-number
            ><span class="quantity_num">库存数量：{{ product.quantity1 }}</span>
          </div>
        </div>
        ...
        <div class="cash_pledge">
          ...
          <div class="cash">
            设备押金：<span>￥{{ product.pledge1 }}</span>
          </div>
        </div>
        ...
        <div class="total">
          <div class="top">
            <div>
              <span class="name">{{ product.name1 }} </span>
            </div>
          </div>
          <p class="totalprice" v-if="isNaN(detailtotal)">总计：70元</p>
...
export default {
  ...
  data() {
    return {
      ...
      product: {
        id: 1,
        name1: "联想ThinkPad X1 Yoga 2020 笔记本电脑",
        price1: "￥70",
        week1: 70.0,
        month1: 266.0,
        quantity1: 30,
  ...
  computed: {
    ...
    detailtotal: function () {
      ...
      if (this.radio1 === 1) {
        ...
        var result = weeknum * 70 * this.num1;
        if (result < 0) {
          var result = 0;
        }
        ...
        var result = monthnum * 266 * this.num1;
        if (result < 0) {
          var result = 0;
        }
  ...
  methods: {
    ...
    immLease(id) {
      ...
      // 租赁数量
      window.sessionStorage.setItem("detailnum", this.num1);
      // var detailnum = sessionStorage.getItem("detailnum");
      // console.log(detailnum + "数量");
      // 租赁名称
      window.sessionStorage.setItem("detailname", this.product.name1);
      ...
      window.sessionStorage.setItem(
        "detailimg",
        "https://oss.aiterent.com/files/2020/12/1606979288789694.jpg?x-oss-process=image/resize,m_fixed,auto-orient,1,w_450,h_450"
      );
