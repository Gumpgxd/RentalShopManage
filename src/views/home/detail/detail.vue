    ...
    <div class="container">
        ...
        <div class="detail-swiper">
          <swiper :options="swiperOption">
            ...
            <swiper-slide class="swiper-item">
              <img
                src="https://z3.ax1x.com/2021/04/11/c0B86H.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://ftp.bmp.ovh/imgs/2021/04/a3ccf385929a9874.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://z3.ax1x.com/2021/04/11/c0Bwh8.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
            <swiper-slide class="swiper-item">
              <img
                src="https://z3.ax1x.com/2021/04/11/c0Bdtf.jpg"
                alt=""
                class="swiper-img"
              />
            </swiper-slide>
      ...
      <div class="right">
        ...
        <div class="header">
          <h2>{{ product.name }}</h2>
          <p class="desc">
            全新 联想ThinkPad X1 Yoga 2020 笔记本电脑（i7-10510U/8GB/512GB
            SSD/Win10H/14"/集显UHD 620/WQHD）
          </p>
          <div class="monthly_rent">
            <div class="color">租金：</div>
            <div class="now-price">{{ product.price }}元起</div>
        ...
        <!-- 选择租赁时间 -->
        <el-radio-group v-model="radio" v-show="choosetime">
          <!-- 第一个 -->
          <div>
            <div class="choose_radio">
              <el-radio :label="1">周租金 {{ product.week }} 元</el-radio>
            ...
            <div class="detail_choose">
              （平均周租金：140元；少于一周按一周算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
          ...
          <div>
            <div class="choose_radio">
              <el-radio :label="2">月租金 {{ product.month }} 元</el-radio>
              <el-button class="default_button default_button1"
                >非固定租期</el-button
              >
              <div class="hint">
            ...
            <div class="detail_choose">
              （平均月租金：520元；少于一个月按一个月算；超过非固定租期，出租方将收取交纳租金的至少20%作为违约金（退还运费由承租方承担）
            </div>
          </div>
        </el-radio-group>
        ...
        <div class="choosenum">
          ...
          <div class="cnum">
            <el-input-number
              ...
              :max="22"
            ></el-input-number
            ><span class="quantity_num">库存数量：{{ product.quantity }}</span>
          </div>
        </div>
        ...
        <div class="total">
          ...
          <p class="totalprice" v-if="isNaN(detailtotal)">总计：140元</p>
...
export default {
  ...
  data() {
    return {
      ...
      product: {
        id: 1,
        name: "联想ThinkPad X1 Yoga 2020 笔记本电脑",
        price: "￥140",
        week: 140.0,
        month: 520.0,
        quantity: 22,
  ...
  computed: {
    ...
    detailtotal: function () {
      // `this` 指向 vm 实例
      // 选择租赁的周或月
      window.sessionStorage.setItem("detailradio", this.radio);
      var detailradio = sessionStorage.getItem("detailradio");
      // console.log(detailradio);
      // 选择租赁的数量
      window.sessionStorage.setItem("detailnum1", this.num);
      var detailnum1 = sessionStorage.getItem("detailnum1");
      // console.log(detailnum1);
      // 选择租赁的时间范围
      // 开始时间
      window.sessionStorage.setItem("detailvalue1", this.value1);
      var detailvalue1 = sessionStorage.getItem("detailvalue1");
      // console.log(detailvalue1);
      // 结束时间
      window.sessionStorage.setItem("detailvalue2", this.value2);
      var detailvalue2 = sessionStorage.getItem("detailvalue2");
      ...
      if (this.radio === 1) {
        ...
        var result = weeknum * 140 * this.num;
        if (result < 0) {
          var result = 0;
        }
        ...
        var result = monthnum * 520 * this.num;
        if (result < 0) {
          var result = 0;
        }
  ...
  methods: {
    ...
    immLease(id) {
      ...
      // 租赁数量
      window.sessionStorage.setItem("detailnum", this.num);
      // var detailnum = sessionStorage.getItem("detailnum");
      // console.log(detailnum + "数量");
      // 租赁名称
      window.sessionStorage.setItem("detailname", this.product.name);
      ...
      // 获取商品图片
      window.sessionStorage.setItem("detailimg", 'https://z3.ax1x.com/2021/04/11/c0B86H.jpg')
